          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1">
              <Card className="p-6 sticky top-28 border-primary/20 shadow-primary/5">
                <h3 className="text-xl font-bold mb-6 pb-4 border-b border-border/50">ملخص الطلب</h3>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex justify-between text-muted-foreground">
                    ...
                    <span>تحسب في الخطوة التالية</span>
                  </div>
                ...
                <Link href="/checkout" className="block w-full">
                  <Button className="w-full gap-2 text-lg py-4">
                    متابعة الدفع <ArrowRight className="w-5 h-5" />
                  </Button>
                </Link>
              </Card>
            </div>
